...
<div class="breadcrumb">
    <h2>Configurações<i class="fas fa-angle-right fa-xs"></i>Usuários<i class="fas fa-angle-right fa-xs"></i>Grupo de Permissões<i class="fas fa-angle-right fa-xs"></i>Adicionar Grupo</h2>
    <span>
