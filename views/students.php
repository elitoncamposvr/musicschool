					...
					<div class="dropdown">
						...
						<div id="myDropdown1" class="dropdown-content">
							<ul>
								...
								<li><a class="dropdown-item" href="<?php echo BASE_URL; ?>students/update/<?php echo $st['id']; ?>"><i class="fas fa-edit"></i> Editar</a></li>
								<li><a class="dropdown-item" href="<?php echo BASE_URL; ?>students/destroy/<?php echo $st['id']; ?>" onclick="return confirm('Deseja realmente excluir?')"><i class="fas fa-trash-alt"></i> Deletar</a></li>
							</ul>
						</div>
					</div>
				</div>
